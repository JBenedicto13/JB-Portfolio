    ...
    <div id="hero-section" className="hero">
      <div className="hero-section">
        <div ref={heroLeftRef} className="hero-left">
          <img
            id="hero"
            src="https://res.cloudinary.com/dxnta6ljp/image/upload/f_auto,q_auto/v1/Portfolio/nwuucuyxcj3bxfxvhhtz"
            alt="hero"
          />
        ...
        <div ref={heroRightRef} className="hero-right">
          <p>
            ...
            <br />
            <p id="whatIDo">a Software Engineer and Graphics Designer</p>
          </p>
